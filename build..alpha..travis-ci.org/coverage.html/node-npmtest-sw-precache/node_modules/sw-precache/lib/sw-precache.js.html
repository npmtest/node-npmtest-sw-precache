...
<div class="header medium">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-sw-precache">npmtest-sw-precache (v0.0.2)</a>
    </h1>
    ...
    <h2>
        ...
        Statements: <span class="metric">60% <small>(75 / 125)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">33.87% <small>(21 / 62)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">72% <small>(18 / 25)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">60% <small>(75 / 125)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
function generate(params, callback) {
  return new Promise(function(resolve, reject) {
    params = defaults(params || <span class="branch-1 cbranch-no" title="branch not covered" >{},</span> {
      cacheId: '',
      clientsClaim: true,
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!Array.isArray(params.ignoreUrlParametersMatching)) {
...
&nbsp;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (params.verbose) {
...
&nbsp;
    Object.keys(params.dynamicUrlToDependencies).forEach(<span class="fstat-no" title="function not covered" >function(dynamicUrl) {</span>
...
&nbsp;
    var runtimeCaching;
    var swToolboxCode;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (params.runtimeCaching) {
...
&nbsp;
      var populatedTemplate = template(data)({
        ...
        directoryIndex: params.directoryIndex || <span class="branch-1 cbranch-no" title="branch not covered" >'',</span>
        ...
        importScripts: params.importScripts ?
          params.importScripts.map(JSON.stringify).join(',') : <span class="branch-1 cbranch-no" title="branch not covered" >null,</span>
        // Ensure that anything false is translated into '', since this will be treated as a string.
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Thu Apr 20 2017 01:57:56 GMT+0000 (UTC)</div>
</div>
</body>
</html>
